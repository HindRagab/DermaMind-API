...
namespace DermaApp.API.Controllers
{
            ...
            var products = new List<Product>
    {
        ...
        new Product { Name = "Cetaphil Moisturizing Cream", Brand = "Cetaphil", Price = 290, Description = "مرطب طبي للبشرة الحساسة", ImageUrl = "https://images.unsplash.com/photo-1611080626919-7cf5a9dbab12?w=300", Category = "Moisturizer" },
